Public Class Role
    ...
    Private Sub B_SAVE_Click(sender As Object, e As EventArgs) Handles B_SAVE.Click
        If eRole.RoleID = 0 And BI.IsRoleNameUnique(txtRoles.Text) Then
            imisGen.Alert(imisGen.getMessage("M_UNIQUEROLENAME"), pnlHeader, alertPopupTitle:="Nafa MIS")
            Return
        End If
        ...
        Catch ex As Exception
            imisGen.Alert(imisGen.getMessage("M_ERRORMESSAGE"), pnlHeader, alertPopupTitle:="Nafa MIS")
