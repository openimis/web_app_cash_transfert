<%@ Page Language="vb" MasterPageFile="~/IMIS.Master" AutoEventWireup="false" CodeBehind="GeneratePayment.aspx.vb" Inherits="IMIS.GeneratePayment" Title='GeneratePay' %>
    ...
    <div class="divBody">
        ...
        <asp:Panel ID="pnlTop" runat="server" CssClass="panelTop" Height="165px" GroupingText='<%$ Resources:Resource,G_HEALTHFACILITY %>' oncontextmenu="return false;">
                ...
                <tr>
                    ...
                    <td class="DataEntry">
                     ...
                     <td class="FormLabel">
                                <asp:Label ID="lblPayrollcycleStatus" Enabled="false"  runat="server" Text="<%$ Resources:Resource,L_BATCHSTATUS %>">
                                </asp:Label>
                            </td>
                            <td class="DataEntry">
                                <asp:TextBox ID="txtPayrollcycleStatus" runat="server"   MaxLength="100" Width="150px"></asp:TextBox> 
                            </td> 
                    <td class="FormLabel">
                        <asp:Label ID="L_REGION" runat="server" Text="<%$ Resources:Resource,L_REGION %>"></asp:Label>
                    </td>
                    <td class="DataEntry">
                        <asp:DropDownList ID="ddlRegion" Enabled="false"  runat="server" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    ...
                    <td class="DataEntry">
                                        <asp:DropDownList ID="ddlMonth" Enabled="false" Width="90px" runat="server">
                                </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td class="DataEntry">
                        <asp:DropDownList ID="ddlproduct" Enabled="false" runat="server">
                        </asp:DropDownList>
                    </td>
                    ...
                    <td class="DataEntry">
                                            <asp:DropDownList ID="ddlMonth1" Enabled="false" Width="90px" runat="server">
                                </asp:DropDownList>
                               </td>
                    ...
                    <td class="DataEntry">
                               <asp:DropDownList ID="ddlYear1" Enabled="false" Width="68px" runat="server">
                                </asp:DropDownList>
                    ...
                    <td class="FormLabel">
                         <asp:LinkButton ID="HideLinkBt" ClientIDMode="Static" runat="server"></asp:LinkButton>
                        <asp:Button class="button" ID="btnSearch" runat="server"
                            Text='Generate' Visible="false" ></asp:Button>
                         <asp:Button class="button" ID="Button1" runat="server" Visible="false" 
                            Text='Download'></asp:Button>

                        <asp:Button runat="server" ID="btnGeneratePay" Visible="false"  OnClick="btnGeneratePay_Click" Text="Generate Payroll" />
                        <asp:Button runat="server" ID="btnGenerateExceptionalPay" Visible="false"  OnClick="btnGenerateExceptional_Click" Text="Generate Exceptional Payroll" />
          ...
          <table>
                 <tr>
                     ...
                     <td>
                             <asp:Panel runat="server" ID="plnRegenerateExcept" Visible="false" >
                                 <asp:Label ID="lblParollAlertExcept" Font-Bold="true" ForeColor="Red" Font-Size="Larger"  runat="server" Text=""></asp:Label>
                                  <br /> <asp:Button runat="server" BackColor="Red" ForeColor="White"  ID="btnRegenerateExcept" OnClick="btnRegeerateExcept_Click" Text=" ReGenerate Exceptional Payroll" Visible="false"  />
                             </asp:Panel>
        ...
        <asp:Panel ID="pnlBody" runat="server" CssClass="panelBody">
            <asp:GridView ID="gvPayments" runat="server"
                ...
                CssClass="mGrid"  DataKeyNames="PaymentDetailsID"
