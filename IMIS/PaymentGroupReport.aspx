<%@ Page Title="Payments" Language="vb" AutoEventWireup="false" MasterPageFile="~/IMIS.Master" CodeBehind="PaymentGroupReport.aspx.vb" Inherits="IMIS.PaymentGroupReport " %>
                        ...
                        <tr>
                            <td>
                                <asp:Label
                                    ID="L_FOUNDPAYMENTS"
                                    runat="server"
                                    Text='<%$ Resources:Resource,L_APPROVEPAYROLL %>'></asp:Label>
                            </td>
